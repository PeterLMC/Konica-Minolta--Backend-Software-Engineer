...
namespace MortgageRiskSystem
{
    ...
    public class MortgageRiskApprovalSystem
    {
        ...
        public IList<MortgageRequest> GetInvalidRequests(string file)
        {
            ...
            List<MortgageRequest> mortageRequests = MountData(file);
            ...
            return BlacKList(deduplicatedRequests);
        }


        public List<MortgageRequest> MountData(string file)
        {
            ...
            return mortageRequests;

        }

        public List<MortgageRequest> BlacKList(List<MortgageRequest> deduplicatedRequests)
        {
